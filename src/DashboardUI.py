...
class DashboardUI(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.cumulative_cases_plots = CumulativeCases("../COVID-19 data by NHS Board 22 July 2020/Table 1 - Cumulative cases.csv",
        ...
        self.icu_patients_confirmed_plots = CumulativeCases("../COVID-19 data by NHS Board 22 July 2020/Table 2a - ICU patients.csv",
        ...
        self.icu_patients_suspected_plots = CumulativeCases("../COVID-19 data by NHS Board 22 July 2020/Table 2b - ICU patients (Hist.).csv",
        ...
        self.hospital_confirmed_plots = CumulativeCases("../COVID-19 data by NHS Board 22 July 2020/Table 3a - Hospital Confirmed.csv",
        ...
        self.hospital_suspected_plots = CumulativeCases("../COVID-19 data by NHS Board 22 July 2020/Table 3b- Hospital Suspected.csv",
