...
class DeathsDataPlots(object):
    ...
    def __init__(self, plot_path=None, plot_title=None, plot_ylabel=None, plot_yticks=None, plot_y_values=None, plot_types_list=None, plot_axis_column_index=None):
