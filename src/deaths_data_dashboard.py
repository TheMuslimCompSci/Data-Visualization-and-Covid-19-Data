...
class DeathsDataDashboard(tk.Frame):
    ...
    def create_widgets(self, buttons):
        for button_text, button_command_values in buttons.items():
            ...
            button_plots = DeathsDataPlots(button_command_values[1], button_command_values[3], button_command_values[4])
            ...
            elif button_text == "COVID Deaths By Age" or "All Deaths By Age":
                button["command"] = button_plots.create_deaths_by_age_plot
